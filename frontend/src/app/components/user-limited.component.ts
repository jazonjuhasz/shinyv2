...
@Component({
    ...
    template: `
      <article>
        ...
        <mat-paginator [length]="count" [pageSizeOptions]="[5, 10]" showFirstLastButtons
...
export class UserLimitedComponent implements OnInit, OnDestroy {
    subscriptions$: Subscription[] = [];
    displayedColumns = ['userName', 'name', 'email'];
    users: User[] = [];
    ...
    ngOnInit(): void {
        this.currentFilters = { limit: 5, offset: 0 };
        this.fetchUsers({ limit: 5, offset: 0, name: null });
    }
